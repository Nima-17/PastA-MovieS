...
export default {
  ...
  mounted() {
    axios
      .get('https://api.themoviedb.org/3/tv/on_the_air?api_key=e31e495fe47500767004b1e3d20123a2')
...
<template>
  ...
  <section class="grid grid-rows-5 grid-cols-4 gap-4 p-3 text-center">
    ...
    >
      ...
      <img class="image w-fit h-fit" v-bind:src="'https://image.tmdb.org/t/p/original' + post.poster_path" />
    </div>
  </section>
</template>
