...
export default {
  ...
  mounted() {
    axios
      .get('https://api.themoviedb.org/3/movie/popular?api_key=e31e495fe47500767004b1e3d20123a2')
...
<template>
  ...
  <section class="grid grid-rows-5 grid-cols-4 gap-4 p-3 text-center">
    <div
      ...
      :key="post.id"
    >
      <div class="flex justify-center items-center absolute right-0 top-0 left-0 bottom-0">
